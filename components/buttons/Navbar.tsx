...
export default function Navbar(){
    ...
    return (
        <>
            ...
            {/* Laptop Navbar */}
            <div className="hidden md:flex fixed top-0 z-50 left-0 right-0 justify-between items-center p-4 bg-white/40 backdrop-blur-sm border-b border-gray-200/50 shadow-sm max-w-[60%] mx-auto rounded-3xl mt-4">
                <Link 
                    href="/homepage" 
